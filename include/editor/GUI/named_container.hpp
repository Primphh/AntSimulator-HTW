...
struct NamedContainer : public Container
{
    ...
    uint8_t background_intensity = 0; // MS02: schwarzes Sidebar-Theme statt hellgrau
        ...
        : Container(Container::Orientation::Vertical)
    {
        ...
        label->setColor(sf::Color::White); // MS02: heller Text für schwarzen Sidebar-Hintergrund
    ...
    {
        const float angle_radius = 0.0f; // MS02: Border-Radius entfernt
