...
struct DefaultConf
{
    ...
    static constexpr uint32_t MAX_COLONIES_COUNT = 3; // MS02: Max. 3 Kolonien
...
template<typename T>
sf::Color DefaultConf<T>::COLONY_COLORS[MAX_COLONIES_COUNT] = {sf::Color(60, 110, 240), sf::Color(160, 32, 240), sf::Color::Green}; // MS02: Blau/Lila/Grün statt Rot/Blau/Gelb - helleres Dunkelblau statt sf::Color::Blue, besser sichtbar auf Schwarz
